...
var (
	...
	ErrConfigDuplicateCfgItem       = New(codeConfigDuplicateCfgItem, ClassConfig, ScopeInternal, LevelMedium, "mysql-instance(%d)'s %s config has duplicate item %s, please remove the duplicate items")
