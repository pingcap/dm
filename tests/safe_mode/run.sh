...
function run() {
    ...
    export GOFAIL_FAILPOINTS='github.com/pingcap/dm/syncer/ReSyncExit=return(false);github.com/pingcap/dm/syncer/WaitShardingSyncExit=return(true);github.com/pingcap/dm/syncer/mode/SafeModeInitialDisable=return(true)'
    ...
    export GOFAIL_FAILPOINTS='github.com/pingcap/dm/syncer/ReSyncExit=return(false);github.com/pingcap/dm/syncer/WaitShardingSyncExit=return(false);github.com/pingcap/dm/syncer/mode/SafeModeInitialDisable=return(true)'
