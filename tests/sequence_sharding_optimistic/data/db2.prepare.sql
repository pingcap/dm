...
create table t2 (id bigint auto_increment primary key, c1 varchar(20), c2 varchar(20));
create table t3 (id bigint auto_increment primary key, c1 varchar(20), c2 varchar(20));
create table t4 (id bigint auto_increment primary key, c1 varchar(20), c2 varchar(20));
