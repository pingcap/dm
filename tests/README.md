...
2. Setup two MySQL servers with binlog enabled first and set `GTID_MODE=ON`, export proper environment variable `MYSQL_HOST1`, `MYSQL_PORT1`, `MYSQL_PASSWORD1` and `MYSQL_HOST2`, `MYSQL_PORT2`, `MYSQL_PASSWORD2`, default is `127.0.0.1`, `3306`, `123456` and `127.0.0.`, `3307`, `123456`.
