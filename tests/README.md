...
2. Setup two MySQL servers (<5.8.0) with binlog enabled first and set `GTID_MODE=ON`, export proper environment variables. Variables and their default values are showed in following table.
