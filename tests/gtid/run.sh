...
function run() {
    ...
    # test if upstream purged binlog, DM should report error
    ...
    # now Previous_gtids event is 09bec856-ba95-11ea-850a-58f2b4af5188:1-4:7

    # remove relay-dir, to check if relay correctly handle gap
