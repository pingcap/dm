...
function exec_full_stage() {
    ...
    exec_sql maria1 3306 "DROP DATABASE IF EXISTS $DB3;"
    exec_sql maria2 3306 "DROP DATABASE IF EXISTS $DB4;"
    exec_sql mysql1 3306 "DROP DATABASE IF EXISTS $DB5;"
    exec_sql mysql2 3306 "DROP DATABASE IF EXISTS $DB6;"
    ...
    exec_sql maria1 3306 "CREATE DATABASE $DB3;"
    exec_sql maria2 3306 "CREATE DATABASE $DB4;"
    exec_sql maria1 3306 "CREATE TABLE $DB3.$TBL1 (c1 INT PRIMARY KEY, c2 TEXT);"
    exec_sql maria1 3306 "CREATE TABLE $DB3.$TBL2 (c1 INT PRIMARY KEY, c2 TEXT);"
    exec_sql maria2 3306 "CREATE TABLE $DB4.$TBL2 (c1 INT PRIMARY KEY, c2 TEXT);"
    exec_sql maria2 3306 "CREATE TABLE $DB4.$TBL3 (c1 INT PRIMARY KEY, c2 TEXT);"

    exec_sql maria1 3306 "INSERT INTO $DB3.$TBL1 (c1, c2) VALUES (1, '1');"
    exec_sql maria1 3306 "INSERT INTO $DB3.$TBL2 (c1, c2) VALUES (2, '2');"
    exec_sql maria2 3306 "INSERT INTO $DB4.$TBL2 (c1, c2) VALUES (11, '11');"
    exec_sql maria2 3306 "INSERT INTO $DB4.$TBL3 (c1, c2) VALUES (12, '12');"

    # prepare pessimistic full data
    exec_sql mysql1 3306 "CREATE DATABASE $DB5;"
    exec_sql mysql2 3306 "CREATE DATABASE $DB6;"
    ...
    exec_sql mysql2 3306 "CREATE TABLE $DB6.$TBL2 (c1 INT PRIMARY KEY, c2 TEXT);"
    exec_sql mysql2 3306 "CREATE TABLE $DB6.$TBL3 (c1 INT PRIMARY KEY, c2 TEXT);"

    exec_sql mysql1 3306 "INSERT INTO $DB5.$TBL1 (c1, c2) VALUES (1, '1');"
    exec_sql mysql1 3306 "INSERT INTO $DB5.$TBL2 (c1, c2) VALUES (2, '2');"
    exec_sql mysql2 3306 "INSERT INTO $DB6.$TBL2 (c1, c2) VALUES (11, '11');"
    exec_sql mysql2 3306 "INSERT INTO $DB6.$TBL3 (c1, c2) VALUES (12, '12');"
}
...
function exec_incremental_stage1() {
    ...
    exec_sql maria1 3306 "INSERT INTO $DB3.$TBL1 (c1, c2) VALUES (101, '101');"
    exec_sql maria1 3306 "INSERT INTO $DB3.$TBL2 (c1, c2) VALUES (102, '102');"
    exec_sql maria2 3306 "INSERT INTO $DB4.$TBL2 (c1, c2) VALUES (111, '111');"
    exec_sql maria2 3306 "INSERT INTO $DB4.$TBL3 (c1, c2) VALUES (112, '112');"

    # optimistic shard ddls
    exec_sql maria1 3306 "ALTER TABLE $DB3.$TBL1 ADD COLUMN c3 INT;"
    exec_sql maria1 3306 "ALTER TABLE $DB3.$TBL2 ADD COLUMN c4 INT;"
    exec_sql maria2 3306 "ALTER TABLE $DB4.$TBL2 ADD COLUMN c3 INT;"
    exec_sql maria2 3306 "ALTER TABLE $DB4.$TBL3 ADD COLUMN c4 INT;"

    # prepare optimistic incremental data
    exec_sql maria1 3306 "INSERT INTO $DB3.$TBL1 (c1, c2, c3) VALUES (103, '103', 103);"
    exec_sql maria1 3306 "INSERT INTO $DB3.$TBL2 (c1, c2, c4) VALUES (104, '104', 104);"
    exec_sql maria2 3306 "INSERT INTO $DB4.$TBL2 (c1, c2, c3) VALUES (113, '113', 113);"
    exec_sql maria2 3306 "INSERT INTO $DB4.$TBL3 (c1, c2, c4) VALUES (114, '114', 114);"
...
function exec_incremental_stage2() {
    ...
    # prepare optimistic incremental data
    exec_sql maria1 3306 "INSERT INTO $DB3.$TBL1 (c1, c2, c3) VALUES (201, '201', 201);"
    exec_sql maria1 3306 "INSERT INTO $DB3.$TBL2 (c1, c2, c4) VALUES (202, '202', 202);"
    exec_sql maria2 3306 "INSERT INTO $DB4.$TBL2 (c1, c2, c3) VALUES (211, '211', 211);"
    exec_sql maria2 3306 "INSERT INTO $DB4.$TBL3 (c1, c2, c4) VALUES (212, '212', 212);"

    # optimistic shard ddls
    exec_sql maria1 3306 "ALTER TABLE $DB3.$TBL1 ADD COLUMN c4 INT;"
    exec_sql maria1 3306 "ALTER TABLE $DB3.$TBL2 ADD COLUMN c3 INT AFTER c2;"
    exec_sql maria2 3306 "ALTER TABLE $DB4.$TBL2 ADD COLUMN c4 INT;"
    exec_sql maria2 3306 "ALTER TABLE $DB4.$TBL3 ADD COLUMN c3 INT AFTER c2;"

    # prepare optimistic incremental data
    exec_sql maria1 3306 "INSERT INTO $DB3.$TBL1 (c1, c2, c3, c4) VALUES (203, '203', 203, 203);"
    exec_sql maria1 3306 "INSERT INTO $DB3.$TBL2 (c1, c2, c3, c4) VALUES (204, '204', 204, 204);"
    exec_sql maria2 3306 "INSERT INTO $DB4.$TBL2 (c1, c2, c3, c4) VALUES (213, '213', 213, 213);"
    exec_sql maria2 3306 "INSERT INTO $DB4.$TBL3 (c1, c2, c3, c4) VALUES (214, '214', 214, 214);"
