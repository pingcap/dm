...
type SyncStatus struct {
	...
	ReaderBinlog     string           `protobuf:"bytes,12,opt,name=readerBinlog,proto3" json:"readerBinlog,omitempty"`
	ReaderBinlogGtid string           `protobuf:"bytes,13,opt,name=readerBinlogGtid,proto3" json:"readerBinlogGtid,omitempty"`
...
func (m *SyncStatus) GetReaderBinlog() string {
	if m != nil {
		return m.ReaderBinlog
	}
	return ""
}

func (m *SyncStatus) GetReaderBinlogGtid() string {
	if m != nil {
		return m.ReaderBinlogGtid
	}
	return ""
}
...
var fileDescriptor_51a1b9e17fd67b10 = []byte{
	...
	,
}
...
func (m *SyncStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ReaderBinlogGtid) > 0 {
		i -= len(m.ReaderBinlogGtid)
		copy(dAtA[i:], m.ReaderBinlogGtid)
		i = encodeVarintDmworker(dAtA, i, uint64(len(m.ReaderBinlogGtid)))
		i--
		dAtA[i] = 0x6a
	}
	if len(m.ReaderBinlog) > 0 {
		i -= len(m.ReaderBinlog)
		copy(dAtA[i:], m.ReaderBinlog)
		i = encodeVarintDmworker(dAtA, i, uint64(len(m.ReaderBinlog)))
		i--
		dAtA[i] = 0x62
	}
...
func (m *SyncStatus) Size() (n int) {
	...
	l = len(m.ReaderBinlog)
	if l > 0 {
		n += 1 + l + sovDmworker(uint64(l))
	}
	l = len(m.ReaderBinlogGtid)
	if l > 0 {
		n += 1 + l + sovDmworker(uint64(l))
	}
	return n
...
func (m *SyncStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReaderBinlog", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ReaderBinlog = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReaderBinlogGtid", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ReaderBinlogGtid = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipDmworker(dAtA[iNdEx:])
