...
// meta of dm-worker
// now it contains TaskMeta map
type WorkMeta struct {
	Tasks map[string]*TaskMeta `protobuf:"bytes,1,rep,name=tasks,proto3" json:"tasks,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *WorkMeta) GetTasks() map[string]*TaskMeta {
	if m != nil {
		return m.Tasks
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*WorkMeta)(nil), "pb.WorkMeta")
	proto.RegisterMapType((map[string]*TaskMeta)(nil), "pb.WorkMeta.TasksEntry")
}
...
var fileDescriptor_51a1b9e17fd67b10 = []byte{
	...
	,
}
...
func (m *WorkMeta) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Tasks) > 0 {
		for k, _ := range m.Tasks {
			...
			if v != nil {
				msgSize = v.Size()
				msgSize += 1 + sovDmworker(uint64(msgSize))
			}
			mapSize := 1 + len(k) + sovDmworker(uint64(len(k))) + msgSize
			i = encodeVarintDmworker(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
			...
			if v != nil {
				dAtA[i] = 0x12
				i++
				i = encodeVarintDmworker(dAtA, i, uint64(v.Size()))
...
func (m *WorkMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Tasks == nil {
				m.Tasks = make(map[string]*TaskMeta)
			}
			var mapkey string
			var mapvalue *TaskMeta
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
