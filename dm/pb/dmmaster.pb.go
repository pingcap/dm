...
const (
	CfgsOp_Export CfgsOp = 0
	CfgsOp_Import CfgsOp = 1
)

var CfgsOp_name = map[int32]string{
	0: "Export",
	1: "Import",
}

var CfgsOp_value = map[string]int32{
	"Export": 0,
	"Import": 1,
}

func (x CfgsOp) String() string {
	return proto.EnumName(CfgsOp_name, int32(x))
}

func (CfgsOp) EnumDescriptor() ([]byte, []int) {
...
type ImportExportCfgsRequest struct {
	Op  CfgsOp `protobuf:"varint,1,opt,name=op,proto3,enum=pb.CfgsOp" json:"op,omitempty"`
	Dir string `protobuf:"bytes,2,opt,name=dir,proto3" json:"dir,omitempty"`
}

func (m *ImportExportCfgsRequest) Reset()         { *m = ImportExportCfgsRequest{} }
func (m *ImportExportCfgsRequest) String() string { return proto.CompactTextString(m) }
func (*ImportExportCfgsRequest) ProtoMessage()    {}
func (*ImportExportCfgsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f9bef11f2a341f03, []int{49}
}
func (m *ImportExportCfgsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ImportExportCfgsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ImportExportCfgsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ImportExportCfgsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ImportExportCfgsRequest.Merge(m, src)
}
func (m *ImportExportCfgsRequest) XXX_Size() int {
	return m.Size()
}
func (m *ImportExportCfgsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ImportExportCfgsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ImportExportCfgsRequest proto.InternalMessageInfo

func (m *ImportExportCfgsRequest) GetOp() CfgsOp {
	if m != nil {
		return m.Op
	}
	return CfgsOp_Export
}

func (m *ImportExportCfgsRequest) GetDir() string {
	if m != nil {
		return m.Dir
	}
	return ""
...
type ImportExportCfgsResponse struct {
	Result  bool      `protobuf:"varint,1,opt,name=result,proto3" json:"result,omitempty"`
	Msg     string    `protobuf:"bytes,2,opt,name=msg,proto3" json:"msg,omitempty"`
	Sources []*Config `protobuf:"bytes,3,rep,name=sources,proto3" json:"sources,omitempty"`
	Tasks   []*Config `protobuf:"bytes,4,rep,name=tasks,proto3" json:"tasks,omitempty"`
}

func (m *ImportExportCfgsResponse) Reset()         { *m = ImportExportCfgsResponse{} }
func (m *ImportExportCfgsResponse) String() string { return proto.CompactTextString(m) }
func (*ImportExportCfgsResponse) ProtoMessage()    {}
func (*ImportExportCfgsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f9bef11f2a341f03, []int{51}
}
func (m *ImportExportCfgsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ImportExportCfgsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ImportExportCfgsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ImportExportCfgsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ImportExportCfgsResponse.Merge(m, src)
}
func (m *ImportExportCfgsResponse) XXX_Size() int {
	return m.Size()
}
func (m *ImportExportCfgsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ImportExportCfgsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ImportExportCfgsResponse proto.InternalMessageInfo

func (m *ImportExportCfgsResponse) GetResult() bool {
	if m != nil {
		return m.Result
	}
	return false
...
func (m *ImportExportCfgsResponse) GetMsg() string {
	if m != nil {
		return m.Msg
	}
	return ""
...
func (m *ImportExportCfgsResponse) GetSources() []*Config {
	if m != nil {
		return m.Sources
	}
	return nil
...
func (m *ImportExportCfgsResponse) GetTasks() []*Config {
	if m != nil {
		return m.Tasks
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("pb.CfgsOp", CfgsOp_name, CfgsOp_value)
	...
	proto.RegisterType((*ImportExportCfgsRequest)(nil), "pb.ImportExportCfgsRequest")
	proto.RegisterType((*Config)(nil), "pb.Config")
	proto.RegisterType((*ImportExportCfgsResponse)(nil), "pb.ImportExportCfgsResponse")
}
...
var fileDescriptor_f9bef11f2a341f03 = []byte{
	...
	,
}
...
type MasterClient interface {
	...
	ImportExportCfgs(ctx context.Context, in *ImportExportCfgsRequest, opts ...grpc.CallOption) (*ImportExportCfgsResponse, error)
}
...
func (c *masterClient) ImportExportCfgs(ctx context.Context, in *ImportExportCfgsRequest, opts ...grpc.CallOption) (*ImportExportCfgsResponse, error) {
	out := new(ImportExportCfgsResponse)
	err := c.cc.Invoke(ctx, "/pb.Master/ImportExportCfgs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MasterServer interface {
	...
	ImportExportCfgs(context.Context, *ImportExportCfgsRequest) (*ImportExportCfgsResponse, error)
}
...
func (*UnimplementedMasterServer) ImportExportCfgs(ctx context.Context, req *ImportExportCfgsRequest) (*ImportExportCfgsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ImportExportCfgs not implemented")
}
...
func _Master_ImportExportCfgs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ImportExportCfgsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MasterServer).ImportExportCfgs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Master/ImportExportCfgs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MasterServer).ImportExportCfgs(ctx, req.(*ImportExportCfgsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Master_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ImportExportCfgs",
			Handler:    _Master_ImportExportCfgs_Handler,
		},
	},
...
func (m *ImportExportCfgsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ImportExportCfgsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ImportExportCfgsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Dir) > 0 {
		i -= len(m.Dir)
		copy(dAtA[i:], m.Dir)
		i = encodeVarintDmmaster(dAtA, i, uint64(len(m.Dir)))
		i--
		dAtA[i] = 0x12
	}
	if m.Op != 0 {
...
func (m *ImportExportCfgsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ImportExportCfgsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ImportExportCfgsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ImportExportCfgsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ImportExportCfgsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ImportExportCfgsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ImportExportCfgsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ImportExportCfgsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ImportExportCfgsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ImportExportCfgsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ImportExportCfgsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
