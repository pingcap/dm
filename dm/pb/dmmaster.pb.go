...
/*
	...
	It has these top-level messages:
		...
		CheckTaskRequest
		CheckTaskResponse
		ShowMasterLeaderRequest
		ShowMasterLeaderResponse
		StartSubTaskRequest
		UpdateRelayRequest
		MigrateRelayRequest
...
func (m *RefreshWorkerTasksResponse) GetMsg() string {
	if m != nil {
		return m.Msg
	}
	return ""
...
type ShowMasterLeaderRequest struct {
}

func (m *ShowMasterLeaderRequest) Reset()                    { *m = ShowMasterLeaderRequest{} }
func (m *ShowMasterLeaderRequest) String() string            { return proto.CompactTextString(m) }
func (*ShowMasterLeaderRequest) ProtoMessage()               {}
func (*ShowMasterLeaderRequest) Descriptor() ([]byte, []int) { return fileDescriptorDmmaster, []int{34} }

// If have leader, result is true, and put leader information in leader_info.
// Otherwise, result is false.
type ShowMasterLeaderResponse struct {
	Result     bool   `protobuf:"varint,1,opt,name=result,proto3" json:"result,omitempty"`
	LeaderInfo string `protobuf:"bytes,2,opt,name=leader_info,json=leaderInfo,proto3" json:"leader_info,omitempty"`
	Msg        string `protobuf:"bytes,3,opt,name=msg,proto3" json:"msg,omitempty"`
}

func (m *ShowMasterLeaderResponse) Reset()         { *m = ShowMasterLeaderResponse{} }
func (m *ShowMasterLeaderResponse) String() string { return proto.CompactTextString(m) }
func (*ShowMasterLeaderResponse) ProtoMessage()    {}
func (*ShowMasterLeaderResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorDmmaster, []int{35}
}

func (m *ShowMasterLeaderResponse) GetResult() bool {
	if m != nil {
		return m.Result
	}
	return false
...
func (m *ShowMasterLeaderResponse) GetLeaderInfo() string {
	if m != nil {
		return m.LeaderInfo
	}
	return ""
...
func (m *ShowMasterLeaderResponse) GetMsg() string {
	if m != nil {
		return m.Msg
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*ShowMasterLeaderRequest)(nil), "pb.ShowMasterLeaderRequest")
	proto.RegisterType((*ShowMasterLeaderResponse)(nil), "pb.ShowMasterLeaderResponse")
}
...
type MasterClient interface {
	...
	// ShowMasterLeader shows the DM-master's leader information
	ShowMasterLeader(ctx context.Context, in *ShowMasterLeaderRequest, opts ...grpc.CallOption) (*ShowMasterLeaderResponse, error)
}
...
func (c *masterClient) ShowMasterLeader(ctx context.Context, in *ShowMasterLeaderRequest, opts ...grpc.CallOption) (*ShowMasterLeaderResponse, error) {
	out := new(ShowMasterLeaderResponse)
	err := grpc.Invoke(ctx, "/pb.Master/ShowMasterLeader", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MasterServer interface {
	...
	// ShowMasterLeader shows the DM-master's leader information
	ShowMasterLeader(context.Context, *ShowMasterLeaderRequest) (*ShowMasterLeaderResponse, error)
}
...
func _Master_ShowMasterLeader_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShowMasterLeaderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MasterServer).ShowMasterLeader(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Master/ShowMasterLeader",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MasterServer).ShowMasterLeader(ctx, req.(*ShowMasterLeaderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Master_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ShowMasterLeader",
			Handler:    _Master_ShowMasterLeader_Handler,
		},
	},
...
func (m *ShowMasterLeaderRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ShowMasterLeaderRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ShowMasterLeaderResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ShowMasterLeaderResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.LeaderInfo) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintDmmaster(dAtA, i, uint64(len(m.LeaderInfo)))
		i += copy(dAtA[i:], m.LeaderInfo)
	}
	if len(m.Msg) > 0 {
		dAtA[i] = 0x1a
		i++
...
func (m *ShowMasterLeaderRequest) Size() (n int) {
	var l int
	_ = l
	return n
}

func (m *ShowMasterLeaderResponse) Size() (n int) {
	var l int
	_ = l
	if m.Result {
		n += 2
...
func (m *ShowMasterLeaderRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ShowMasterLeaderRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ShowMasterLeaderRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *ShowMasterLeaderResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ShowMasterLeaderResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ShowMasterLeaderResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			m.LeaderInfo = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Msg", wireType)
...
var fileDescriptorDmmaster = []byte{
	...
	,
}
