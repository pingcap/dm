...
func (m *FetchSourceInfoRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FetchSourceInfoRequest.Merge(m, src)
}
...
type FetchSourceInfoResponse struct {
	Result     bool          `protobuf:"varint,1,opt,name=result,proto3" json:"result,omitempty"`
	Msg        string        `protobuf:"bytes,2,opt,name=msg,proto3" json:"msg,omitempty"`
	SourceInfo []*SourceInfo `protobuf:"bytes,3,rep,name=sourceInfo,proto3" json:"sourceInfo,omitempty"`
}
...
func (m *FetchSourceInfoResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FetchSourceInfoResponse.Merge(m, src)
}
...
func (*UnimplementedMasterServer) FetchSourceInfo(ctx context.Context, req *FetchSourceInfoRequest) (*FetchSourceInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FetchSourceInfo not implemented")
}
