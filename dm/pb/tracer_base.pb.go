...
func (TraceType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_tracer_base_eb78fe39c9a10136, []int{0}
}
...
func (dst *BaseEvent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BaseEvent.Merge(dst, src)
}
...
func init() { proto.RegisterFile("tracer_base.proto", fileDescriptor_tracer_base_eb78fe39c9a10136) }

var fileDescriptor_tracer_base_eb78fe39c9a10136 = []byte{
