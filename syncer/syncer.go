...
func (s *Syncer) Init(ctx context.Context) (err error) {
	...
	s.streamerController = NewStreamerController(s, s.syncCfg, s.cfg.EnableGTID, s.fromDB, s.binlogType, s.cfg.RelayDir, s.timezone)
...
func (s *Syncer) adjustGlobalPointGTID(tctx *tcontext.Context) (bool, error) {
	...
	streamerController := NewStreamerController(s, s.syncCfg, false, s.fromDB, s.binlogType, s.cfg.RelayDir, s.timezone)
