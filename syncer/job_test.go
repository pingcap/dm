...
func (t *testJobSuite) TestJob(c *C) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			newFlushJob(),
			"tp: flush, sql: , args: [], key: , ddls: [], last_location: position: (, 0), gtid-set: , start_location: position: (, 4), gtid-set: , current_location: position: (, 0), gtid-set: ",
		}, {
			newSkipJob(binlog.NewLocation("")),
			"tp: skip, sql: , args: [], key: , ddls: [], last_location: position: (, 4), gtid-set: , start_location: position: (, 4), gtid-set: , current_location: position: (, 0), gtid-set: ",
		},
	}
