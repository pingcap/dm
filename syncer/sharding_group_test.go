...
func (t *testShardingGroupSuite) TestLowestFirstPosInGroups(c *C) {
	...
	g1 := NewShardingGroup(cfg, []string{"db1.tbl1", "db1.tbl2"}, nil, false)
	...
	// lowest
	g2 := NewShardingGroup(cfg, []string{"db2.tbl1", "db2.tbl2"}, nil, false)
	...
	g3 := NewShardingGroup(cfg, []string{"db3.tbl1", "db3.tbl2"}, nil, false)
