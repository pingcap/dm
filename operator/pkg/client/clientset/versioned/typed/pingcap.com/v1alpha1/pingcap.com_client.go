...
import (
	...
	"github.com/pingcap/dm/operator/pkg/client/clientset/versioned/scheme"
...
func (c *PingcapV1alpha1Client) DMMetas(namespace string) DMMetaInterface {
	return newDMMetas(c, namespace)
}

func (c *PingcapV1alpha1Client) DMNodes(namespace string) DMNodeInterface {
	return newDMNodes(c, namespace)
}

func (c *PingcapV1alpha1Client) DMTasks(namespace string) DMTaskInterface {
	return newDMTasks(c, namespace)
}
